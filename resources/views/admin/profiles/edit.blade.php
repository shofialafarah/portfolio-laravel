    ...
    <div class="max-w-3xl mx-auto">
        ...
        <form method="POST" action="{{ route('admin.profiles.update') }}" enctype="multipart/form-data"
                    ...
                    <div class="flex items-center gap-6">
                        @if ($profile->photo)
                            <div class="relative group">
                                ...
                                <div
                                    class="absolute inset-0 bg-black/40 rounded-2xl opacity-0 group-hover:opacity-100 flex items-center justify-center transition-all cursor-default">
            ...
            <div class="mt-10 pt-6 border-t border-white/5 flex justify-end">
                <button
                    class="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-3 rounded-xl font-bold transition-all shadow-lg shadow-indigo-600/20 active:scale-95">
                    Simpan Perubahan
                </button>
            </div>
        </form>
