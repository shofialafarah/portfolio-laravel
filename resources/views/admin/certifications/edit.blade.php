        ...
        <div class="relative group">
            ...
            <form action="{{ route('admin.certifications.update', $certification) }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label
                            class="block text-sm font-bold text-zinc-400 uppercase tracking-widest mb-2">Penyelenggara</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
                    <div class="space-y-3">
                        <span class="block text-sm font-bold text-zinc-400 uppercase tracking-widest">Sertifikat Saat
                            Ini</span>
                        <div
                            class="p-2 bg-zinc-900 border border-white/5 rounded-2xl flex justify-center overflow-hidden h-36">
                    ...
                    <div>
                        <span class="block text-sm font-bold text-zinc-400 uppercase tracking-widest mb-3">Ganti
                            Gambar</span>
                        <input type="file" name="image" id="cert-image" accept="image/*" class="hidden">
                        <label for="cert-image"
                            class="w-full bg-zinc-900/50 border-2 border-dashed border-white/10 text-zinc-500 rounded-xl px-4 py-10 flex flex-col items-center justify-center gap-2 cursor-pointer hover:border-emerald-500/50 transition-all">
